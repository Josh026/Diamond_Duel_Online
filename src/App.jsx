...
export default function BaseballGame(){
  ...
  useEffect(()=>{
    ...
    console.log("[ONLINE PUSH]", onlineSide, "phase:", g.phase, "_turn:", g._turn, "key:", key);
  ...
  useEffect(()=>{
    ...
    const poll = setInterval(async()=>{
      try{
        ...
        console.log("[ONLINE POLL]", onlineSide, "got phase:", remote?.phase, "_turn:", remote?._turn, "_writer:", remote?._writer, "status:", remote?.status);
        ...
        if(!remote._writer||remote._writer===onlineSide){ console.log("[ONLINE POLL] ignoring - own write or no writer"); return; }
        ...
        setG(prev=>{
          if(prev._turn === onlineSide) return prev; // we currently own state — don't overwrite
          return{
            ...remote,
  ...
  function choosePitch(pitchId){ console.log("[choosePitch]", onlineSide, pitchId); setG(prev=>({...prev,pitchChosen:pitchId,phase:"batting",_turn:prev.topBottom==="top"?"home":"away"}));} // pitcher wrote this
