...
export default function BaseballGame(){
  ...
  useEffect(()=>{
    ...
    const poll = setInterval(async()=>{
      try{
        ...
        addDebug(`✅ APPLY [${onlineSide}] ${remote.phase} _turn:${remote._turn}`);
        setG(prev=>({
          ...remote,
  ...
  // ── MENU ──────────────────────────────────────────────────────────────────
  // Debug panel shown in online mode on any screen
  const debugPanel = g.mode==="online"||onlineState!=="idle"
