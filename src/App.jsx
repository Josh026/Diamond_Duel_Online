...
class ErrorBoundary extends React.Component {
  ...
  render(){
    if(this.state.err) return(
      <div style={{background:"#0a0f1a",color:"#f87171",minHeight:"100vh",padding:20,fontFamily:"monospace",fontSize:11,whiteSpace:"pre-wrap",wordBreak:"break-all"}}>
        CRASH — share this with developer:\n{this.state.err}
      </div>
    );
...
export default function App(){ return <ErrorBoundary><BaseballGame/></ErrorBoundary>; }
